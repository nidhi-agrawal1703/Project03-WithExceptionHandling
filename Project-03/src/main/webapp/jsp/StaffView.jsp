...
<%@page import="in.co.rays.proj3.controller.StaffCtl"%>
...
<!-- Bean Tag -->
	<jsp:useBean id="dto" class="in.co.rays.proj3.dto.StaffDTO" scope="request"></jsp:useBean>
			...
			<div class="col-md-6">
				<div class="card input-group-addon">
					<div class="card-body">
						...
						<%}else { %>
						<h3 class="text-center text-primary pb-3">Add Staff</h3>
						<%} %>
						...
						<!-- Name -->
 						...
 						<!-- Joining Date -->
 							<label><b>Joining Date</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
							...
							<!-- Previous Employer -->
 							<label><b>Previous Employer</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
                    ...
                    <div class="text-center">                            
                                <input type="submit" class="btn btn-success" name="operation" value="<%=StaffCtl.OP_UPDATE%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=StaffCtl.OP_CANCEL%>"><br>  								                          
                            </div> 							
                    ...
                    %>
                    <div class="text-center">                            
                                <input type="submit" class="btn btn-success" name="operation" value="<%=StaffCtl.OP_SAVE%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=StaffCtl.OP_RESET%>"><br>  								                          
                            </div> 							

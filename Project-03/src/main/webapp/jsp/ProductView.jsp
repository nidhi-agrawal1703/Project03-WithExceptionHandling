...
<%@page import="in.co.rays.proj3.controller.ProductCtl"%>
...
<!-- Bean Tag -->
	<jsp:useBean id="dto" class="in.co.rays.proj3.dto.ProductDTO" scope="request"></jsp:useBean>
			...
			<div class="col-md-6">
				<div class="card input-group-addon">
					<div class="card-body">
						...
						<%}else { %>
						<h3 class="text-center text-primary pb-3">Add Product</h3>
						<%} %>
						...
						<!-- Product Category -->
 							...
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
 									<span class="input-group-text" id="basic-addon1"><i class="fa fa-tags" style="font-size: 25px;"></i></span>
 							...
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
 									<span class="input-group-text" id="basic-addon1"><i class="fa fa-rupee-sign" style="font-size: 25px;"></i></span>
                    ...
                    <div class="text-center">                            
                                <input type="submit" class="btn btn-success" name="operation" value="<%=ProductCtl.OP_UPDATE%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=ProductCtl.OP_CANCEL%>"><br>  								                          
                            </div> 							
                    ...
                    %>
                    <div class="text-center">                            
                                <input type="submit" class="btn btn-success" name="operation" value="<%=ProductCtl.OP_SAVE%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=ProductCtl.OP_RESET%>"><br>  								                          
                            </div> 							

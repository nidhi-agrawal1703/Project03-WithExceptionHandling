			...
			<div class="col-md-6">
				<div class="card input-group-addon">
					<div class="card-body">
						...
						<%}else { %>
						<h3 class="text-center text-primary pb-3">Add Course</h3>
						<%} %>
						...
						<!-- Name -->
 						...
 						<!-- Duration -->
 							<label><b>Duration</b><span style="color:red">*</span></label>
 							<div class="input-group mb-3">
 								<div class="input-class-prepend">
                    ...
                    <div class="text-center">                            
                                <input type="submit" class="btn btn-success" name="operation" value="<%=CourseCtl.OP_UPDATE%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=CourseCtl.OP_CANCEL%>"><br>  								                          
                            </div> 							
                    ...
                    %>
                    <div class="text-center">                            
                                <input type="submit" class="btn btn-success" name="operation" value="<%=CourseCtl.OP_SAVE%>" >
                                <input type="submit" class="btn btn-secondary" name="operation"value="<%=CourseCtl.OP_RESET%>"><br>  								                          
                            </div> 							

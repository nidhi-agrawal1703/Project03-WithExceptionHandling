				...
				<div class="card input-group-addon">
					<div class="card-body">
						<%
							...
							if(dto.getId()!=null){						
						%>				
						<h3 class="text-center text-primary pb-3">Update Subject</h3>
						<%}else { %>
						<h3 class="text-center text-primary pb-3">Add Subject</h3>
						<%} %>
                    ...
                    <div class="text-center">                            
                                <button class="btn btn-success" name="operation" value="<%=SubjectCtl.OP_UPDATE%>" >Update</button>
                                <button class="btn btn-secondary" name="operation"value="<%=SubjectCtl.OP_CANCEL%>">Cancel</button><br>  								                          
                            </div> 							
                    ...
                    %>
                    <div class="text-center">                            
                                <button class="btn btn-success" name="operation" value="<%=SubjectCtl.OP_SAVE%>" >Save</button>
                                <button class="btn btn-secondary" name="operation"value="<%=SubjectCtl.OP_RESET%>">Reset</button><br>  								                          
                            </div> 							
